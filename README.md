#### Here is a Colab notebook made by me that builds from source and installs the dependencies manually and can be opened via [![Open In Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://colab.research.google.com/github/Erick2317/Infinite-Storage-Glitch/blob/master/Infinite_Storage_Glitch.ipynb). Just follow the instructions and feel free to make any suggestions/improvements! 
